...
function MITTShowData(k)
	...
	if k == Player:GetName() then 
		lblName:SetForeColor( Color["green"] );
		CopperLbl:SetForeColor( Color["green"] );
		SilverLbl:SetForeColor( Color["green"] );
		GoldLbl:SetForeColor( Color["green"] );
	else 
		lblName:SetForeColor( Color["white"] ); 
	end
